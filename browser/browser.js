...
onload = function() {
  ...
  webview.addEventListener('dom-ready', function() {
      ...
      console.log("registering will-prevent-unload for webview");
      webview.getWebContents().webContents.addListener('will-prevent-unload', function(e) {
          console.log("webview's will-prevent-unload called with e.preventDefault() NOT working as expected. The guest page event handler 'beforeunload' is not ignored, and the page does not get unloaded.");
          e.preventDefault();
      });
  });
};
...
window.onbeforeunload = function(e) {
    console.log("registering window.onbeforeunload. This should prevent from unloading the main browser window, and the registered 'will-prevent-unload' event handler on main window correctly ignores it.");
    e.returnValue = "browser.onbeforeunload";
    return "browser.onbeforeunload";
}